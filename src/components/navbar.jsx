export default function Navbar(){
    return (
        <nav class="bg-white dark:bg-gray-900 fixed h-24 w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
          <div class="mt-3 max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
              <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Exdecode</span>
            </a>
